...
### [Indium](https://github.com/k4runa/indium) — Narrative-First 2D Game Engine `C++20`
...
### [Kintsugi](https://github.com/k4runa/kintsugi) — Storage Engine + Credential Manager `C++20`
...
### [EcoFil](https://github.com/k4runa/ecofil) — Media Library & Discovery Platform `Python`
...
### [eco](https://github.com/k4runa/eco) — Update Manager for Arch `Python`
...
### [ffpilot](https://github.com/k4runa/ffpilot) — ffmpeg TUI `C++17`
...
[Turkish news classifier](https://github.com/k4runa/ttc4900) — BERT fine-tune on TTC4900, served over FastAPI. Some smaller ML experiments and a Discord bot live in private repos.
...
<p align="center">
  <img src="https://raw.githubusercontent.com/k4runa/k4runa/output/github-contribution-grid-snake-dark.svg" />
</p>
